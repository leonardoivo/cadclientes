...
namespace Tiradentes.CobrancaAtiva.Services.Interfaces
{
    public interface IParcelasAcordoService : IDisposable
    {
        ...
        Task AtualizaPagamentoParcelaAcordo(decimal parcela, decimal numeroAcordo, DateTime dataPagamento, DateTime dataBaixa, decimal valorPago, string situacaoPagamento);
