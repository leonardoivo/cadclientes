...
namespace Tiradentes.CobrancaAtiva.Domain.Interfaces
{
    public interface IParcelasAcordoRepository : IBaseRepository<ParcelasAcordoModel>
    {
        ...
        Task AtualizarPagamentoParcelaAcordo(decimal parcela, decimal numeroAcordo, DateTime dataPagamento, DateTime dataBaixa, decimal valorPago, char? situacaoPagamento);
