...
{
    public class ObterValorParcelaAcordo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes4")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste obter parcela acordo válido",
                   Description = "Teste obter parcela acordo no Banco")]
        public void TesteObterValorParcelaAcordoValido()
        {
            var result = _service.ObterValorParcelaAcordo(_model.Parcela, _model.NumeroAcordo);

            Assert.AreEqual(_model.Valor, result);
        }
    }
}
