...
{
    public class QuitarParcelasAcordo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes9")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste quitar parcela acordo válido",
                   Description = "Teste quitar parcela acordo no banco")]
        public async Task TesteQuitarParcelasAcordoValido()
        {
            await _service.QuitarParcelasAcordo(_model.NumeroAcordo, 1, _model.Sistema, DateTime.Now, 1, 1, 1, 1, 1, 1, 1, 1, 1, _model.CnpjEmpresaCobranca);
