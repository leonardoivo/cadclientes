...
{
    public class EstornarParcelaAcordo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes3")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste estornar parcela paga válido",
                   Description = "Teste estornar parcela paga no Banco, deve retornar 'InvalidOperationException' por tentar usar procedure in memory")]
        public void TesteEstornarParcelaAcordoValido()
        {
            Assert.ThrowsAsync<InvalidOperationException>(async () => await _service.EstornarParcelaAcordo(_model.Parcela, _model.NumeroAcordo));
        }
    }
}
