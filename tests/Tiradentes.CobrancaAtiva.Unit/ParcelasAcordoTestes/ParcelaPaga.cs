...
namespace Tiradentes.CobrancaAtiva.Unit.ParcelasAcordoTestes
{
    public class ParcelaPaga
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes8")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste parcela paga válido",
                   Description = "Teste parcela paga no Banco")]
        public void TesteParcelaPagaValido()
        {
            var result = _service.ParcelaPaga(_model.Parcela, _model.NumeroAcordo);
