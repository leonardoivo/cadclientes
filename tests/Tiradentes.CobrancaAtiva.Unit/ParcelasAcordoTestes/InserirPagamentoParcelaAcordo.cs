...
{
    public class InserirPagamentoParcelaAcordo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes7")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste inserir pagamento parcela acordo válido",
                   Description = "Teste inserir pagamento parcela acordo no banco, deve retornar 'InvalidOperationException' por tentar usar procedure in memory")]
        public void TesteInserirPagamentoParcelaAcordoValido()
        {
            Assert.ThrowsAsync<InvalidOperationException>(async () => await _service.InserirPagamentoParcelaAcordo(_model.Parcela, _model.NumeroAcordo, _model.Sistema, DateTime.Now, DateTime.Now, _model.Valor, _model.CnpjEmpresaCobranca, _model.TipoInadimplencia));
        }
    }
}
