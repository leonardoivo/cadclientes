...
{
    public class AtualizaPagamentoParcelaAcordo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes6")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste atualizar pagamento parcela acordo válido",
                   Description = "Teste atualizar pagamento parcela acordo no banco, deve retornar 'InvalidOperationException' por tentar usar procedure in memory")]
        public void TesteAtualizaPagamentoParcelaAcordoValido()
        {
            Assert.ThrowsAsync<InvalidOperationException>(async () => await _service.AtualizaPagamentoParcelaAcordo(_model.Parcela, _model.NumeroAcordo, DateTime.Now, DateTime.Now, 100, _model.SituacaoPagamento));
        }
    }
}