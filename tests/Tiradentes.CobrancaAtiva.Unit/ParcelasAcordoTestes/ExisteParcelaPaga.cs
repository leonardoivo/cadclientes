...
{
    public class ExisteParcelaPaga
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasAcordoTestes")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste verificar parcela paga válido",
                   Description = "Teste verificar parcela paga no Banco")]
        public void TesteExisteParcelaPagaValido()
        {
            var result = _service.ExisteParcelaPaga(_model.NumeroAcordo);
