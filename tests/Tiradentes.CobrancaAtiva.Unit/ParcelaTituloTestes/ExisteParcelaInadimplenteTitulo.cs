...
{
    public class ExisteParcelaInadimplenteTitulo
    {
        ...
        public void Setup()
        {
            DbContextOptions<CobrancaAtivaDbContext> optionsContext =
                new DbContextOptionsBuilder<CobrancaAtivaDbContext>()
                    .UseInMemoryDatabase("ParcelasTituloTestes2")
                    .Options;
        ...
        [Test]
        [TestCase(TestName = "Teste verificar parcela inadimplente Titulo válido",
                   Description = "Teste verificar parcela inadimplente Titulo no Banco")]
        public void TesteExisteParcelaInadimplenteTituloValido()
        {
            var result = _service.ExisteParcelaInadimplente(_model.DataBaixa);
