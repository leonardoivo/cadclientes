...
namespace Tiradentes.CobrancaAtiva.Unit.AcordoCobrancaTestes
{
    public class ExisteAcordo
    {
        ...
        [Test]
        [TestCase(TestName = "Teste existe acordo cobrança válido",
                   Description = "Teste existe acordo cobrança no Banco")]
        public void TesteExisteAcordoValido()
        {
            var result = _service.ExisteAcordo(_model.NumeroAcordo);
