...
{
    public class AtualizarSaldoDevedor
    {
        ...
        [Test]
        [TestCase(TestName = "Teste saldo devedor acordo de cobrança válido",
                   Description = "Teste saldo devedor acordo de cobrança no Banco")]
        public void TesteAtualizarSaldoDevedorValido()
        {
            var result = _service.AtualizarSaldoDevedor(_model.NumeroAcordo, 1000);
